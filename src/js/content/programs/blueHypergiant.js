content.programs.blueHypergiant = content.programs.invent({
  ...
  alterParticleColor: function (particle, point) {
    ...
    particle.target.s = (engine.fn.scale(Math.sin(engine.const.tau * time * particle.twinkleFrequencies[1]), -1, 1, 0, 1) ** 0.5) * engine.fn.lerp(0.25, 1, this.options.star.radius)
